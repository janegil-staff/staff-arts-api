...
// ─── Sub-schema ───────────────────────────────────────────────────────────────
const coverImageSchema = new mongoose_1.Schema({ url: String, publicId: String }, { _id: false });
// ─── Schema ───────────────────────────────────────────────────────────────────
const exhibitionSchema = new mongoose_1.Schema({
    ...
    artworks: [{ type: mongoose_1.Schema.Types.ObjectId, ref: 'Artwork' }],
    artists: [{ type: mongoose_1.Schema.Types.ObjectId, ref: 'User' }],
...
exports.default = mongoose_1.default.model('Exhibition', exhibitionSchema);
