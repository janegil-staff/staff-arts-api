...
const postSchema = new mongoose.Schema(
  {
    ...
    type: {
      type: String,
      enum: ["post", "review", "story", "announcement"],
      default: "post",
    },
...
const eventSchema = new mongoose.Schema(
  {
    ...
    category: { type: String, enum: ["exhibition", "event", "music"], default: "event" },
    coverImage: { url: String, publicId: String },
...
export const MusicTrack =
  mongoose.models.MusicTrack || mongoose.model("MusicTrack", musicTrackSchema);
